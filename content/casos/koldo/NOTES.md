...
- **Cifras económicas publicables:** queda estructurado como objeto económico de la pieza inicial el total de 32,5 M € de los dos contratos de mascarillas de Puertos del Estado y ADIF, con soporte CENDOJ N1. También quedan estructuradas las consecuencias de sentencia (responsabilidad civil y decomiso). No se modela todavía un total agregado de todas las piezas, comisiones o ramificaciones; requiere primarios completos y revisión anti-doble-conteo.
- **Sección pública de contenido no modelado:** se añaden dos decisiones a `caso.yaml`: no publicar aún total económico agregado (contratos/comisiones/piezas conexas) y no modelar todavía la relación Plus Ultra↔Koldo por Apamate/Aldama. Se dejan fuera de la sección pública otros temas detectados (reacciones políticas, tesis de financiación irregular, chats/jerga, testigos/personas privadas y ramificaciones Aldama/Air Europa/Villafuel) por encajar mejor en seguimiento interno o requerir primario específico.
