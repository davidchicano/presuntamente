...
- **GIL (Grupo Independiente Liberal)**: Se crea organización nueva `grupo-independiente-liberal` ya que no existe en el inventario. El partido fue el vehículo político de la trama.
  - **CIF/NIF — pendiente_primario (sweep API, 2026-06-05):** queda **vacío** en `grupo-independiente-liberal.yaml`. NIF esperado por **G** (`G29xxxxx`, provincia de Málaga). Dos pasadas de sub-agentes no lo localizaron: el BOE de candidaturas no lista NIFs, las bases comerciales no indexan partidos, y los **informes del Tribunal de Cuentas** sobre financiación de partidos (ejercicios 1999-2002, Nº 580/607/693) —que sí traen el NIF en sus tablas— son **PDF escaneado, no extraíble** (requieren OCR). El partido fue disuelto (~2007), lo que reduce su huella registral. **Acción:** OCR sobre esos informes del Tribunal de Cuentas si recibió subvención estatal (obtuvo 72.162 votos en generales 2000).
