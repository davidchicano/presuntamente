...
**Anterior (2026-06-04).** **API de datos abiertos `/api/v1/`** (9 endpoints + `/llms.txt` + CORS; más estricta que la web: excluye retractados y `promocion_propuesta`; **CIF poblado 1→67**; suite `vitest` en CI) — canon [`docs/api/`](docs/api/README.md) + [`api-datos-abiertos.md`](docs/web/features/api-datos-abiertos.md). · **Explorador `/conexiones`**: `cose`→`fcose` (~10× más rápido) — [`explorador-conexiones.md`](docs/web/features/explorador-conexiones.md). Detalle de sesiones: [`historial-2026-06.md`](docs/roadmap/historial-2026-06.md).
